...
const SETTINGS_REGISTRY: Record<string, SettingsSectionEntry> = {
	...
	[SETTINGS_SECTION_SLUGS.CONNECTIONS]: {
		...
		settings: [
			...
			{
				key: SETTINGS_KEYS.SELECTED_PERSONA,
				label: 'Masbro Character',
				help: 'Select the character persona configuration for Gemini models.',
				defaultValue: 'standar',
				type: SettingsFieldType.SELECT,
				section: SETTINGS_SECTION_SLUGS.CONNECTIONS,
				options: [
					{ value: 'formal', label: 'Formal', icon: Smile },
					{ value: 'standar', label: 'Default', icon: Smile },
...
const NON_UI_SETTINGS: SettingsEntry[] = [
	{
		...
		help: 'The application uses Gemini API. All requests are securely proxied server-side.',
		defaultValue: 'google',
		type: SettingsFieldType.SELECT,
	...
	},
	{
		...
		label: 'Temperature',
		help: 'Controls the randomness of the generated text by affecting the probability distribution of the output tokens.',
	...
	},
	{
		...
		help: 'Addon for the temperature sampler.',
		defaultValue: undefined,
		type: SettingsFieldType.INPUT,
	...
	},
	{
		...
		label: 'Min P',
		help: 'Limits tokens based on the minimum probability for a token to be considered.',
		defaultValue: undefined,
		type: SettingsFieldType.INPUT,
	...
	},
	{
		...
		label: 'Max tokens',
		help: 'The maximum number of token per output.',
		defaultValue: undefined,
		type: SettingsFieldType.INPUT,
	...
	},
	{
		...
		label: 'Samplers',
		help: 'The order at which samplers are applied.',
		defaultValue: '',
		type: SettingsFieldType.INPUT,
	...
	},
	{
		...
		help: 'Enable backend-based samplers.',
		defaultValue: false,
		type: SettingsFieldType.CHECKBOX,
	...
	},
	{
		...
		help: 'After each response, re-submit the conversation to pre-fill the server KV cache.',
		defaultValue: false,
		type: SettingsFieldType.CHECKBOX,
		sync: { serverKey: SETTINGS_KEYS.PRE_ENCODE_CONVERSATION, paramType: SyncableParameterType.BOOLEAN }
	},
	{
