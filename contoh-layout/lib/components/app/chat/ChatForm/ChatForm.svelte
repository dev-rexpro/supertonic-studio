...
>
	...
	<div
		class="bg-white/70 dark:bg-muted/40 border border-black/10 dark:border-white/10 shadow-sm outline-none text-foreground overflow-visible rounded-[20px] backdrop-blur-md transition-all focus-within:shadow-md bg-clip-padding {disabled
	...
	>
		...
		<div
			class="flex-column relative min-h-12 items-center rounded-[20px] py-2 pb-2.25 md:py-3!"
			onpaste={handlePaste}
		>
			<ChatFormTextarea
				class="px-5 pt-1.5 pb-0 md:pt-0"
