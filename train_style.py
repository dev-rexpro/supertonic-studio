...
def build_parser():
    ...
    parser.add_argument("--name", default="mb4", help="Output name for logs and saved style")
    parser.add_argument("--gender", default="M", choices=["F", "M"], help="Voice gender for selecting the default reference style")
    parser.add_argument("--target-wav-path", default="voices/mb4.wav", help="Path to the target WAV file")
